...
class Satelite:
    def __init__(self, *args):
        ...
        self.config.instance_id = "af043602-6130-4dda-b431-07d940f540f8"
        self.config.sh_client_id = "62506301-fec5-4d8f-b11e-513d97de9d0d"
        self.config.sh_client_secret = "%Rht;DI}|**@R9?M-1{m0_,clB&,YrYfmTY,bKF1"
        self.config.save()
